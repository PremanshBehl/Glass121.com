      ...
      <div className="w-full max-w-xl bg-[#11141e] border border-white/10 rounded-2xl p-8 relative z-10 shadow-2xl">
            ...
            {[1, 2].map(i => (
              <div key={i} className="flex flex-col items-center">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-colors ${
                  ...
                  step === i ? 'bg-accent-cyan text-primary-dark' : 'bg-gray-800 text-gray-500'
                }`}>
        ...
        {step === 1 && (
          <form onSubmit={handleNext}>
            ...
            <button type="submit" className="w-full bg-accent-cyan hover:bg-[#00bfe6] text-primary-dark font-bold py-3 rounded-lg transition-colors">
              Continue
            </button>
        ...
        {step === 2 && (
          <form onSubmit={handleComplete}>
            ...
            <div className="flex gap-3">
              <button type="button" onClick={() => setStep(1)} className="px-6 py-3 border border-white/20 text-white rounded-lg hover:bg-white/5 transition-colors">
                Back
              </button>
              <button type="submit" disabled={!role} className="flex-1 bg-accent-cyan hover:bg-[#00bfe6] text-primary-dark font-bold py-3 rounded-lg transition-colors disabled:opacity-50">
                Complete Sign Up
              </button>
            </div>
          </form>
